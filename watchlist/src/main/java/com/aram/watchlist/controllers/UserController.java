package com.aram.watchlist.controllers;
...
import com.aram.watchlist.models.LoginUser;
import com.aram.watchlist.models.User;
import com.aram.watchlist.services.UserService;
...
public class UserController {
	...
	public String register(@Valid @ModelAttribute("newUser") User newUser,
		...
		if(result.hasErrors()) {
			...
			session.setAttribute("name", registerUser.getUsername());
